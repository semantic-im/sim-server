...
# Dumping data for table larkc.metrics: ~106 rows (approximately)
/*!40000 ALTER TABLE `metrics` DISABLE KEYS */;
INSERT INTO `metrics` (`idMetric`, `Name`, `MetricType`, `Title`, `Description`, `MetricTableName`) VALUES
	(1, 'QueryBeginExecutionTime', 2, NULL, NULL, NULL),
	(2, 'QueryEndExecutionTime', 2, NULL, NULL, NULL),
	(3, 'QueryErrorStatus', 3, NULL, NULL, NULL),
	(4, 'QueryContent', 1, NULL, NULL, NULL),
...
# Dumping data for table larkc.platforms_metrics: ~571 rows (approximately)
...
# Dumping data for table larkc.platforms_workflows: ~1 rows (approximately)
...
# Dumping data for table larkc.plugins_metrics: ~36 rows (approximately)
...
# Dumping data for table larkc.queries_metrics: ~32 rows (approximately)
...
# Dumping data for table larkc.vis_settings: 3 rows
/*!40000 ALTER TABLE `vis_settings` DISABLE KEYS */;
INSERT INTO `vis_settings` (`SettingName`, `SettingValue`) VALUES
	('StartDate', '2011-08-17 12:00:00'),
	('EndDate', '2011-08-23 12:00:00');
...
# Dumping data for table larkc.workflows_metrics: ~24 rows (approximately)
...
# Dumping data for table larkc.workflows_plugins: ~2 rows (approximately)
